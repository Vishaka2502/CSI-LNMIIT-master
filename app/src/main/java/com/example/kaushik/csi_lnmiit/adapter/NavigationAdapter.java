package com.example.kaushik.csi_lnmiit.adapter;
...
public class NavigationAdapter extends BaseAdapter {
	...
	public void setHomeCounter(int count){
		mHomeCounter = count;
		mList.get(Constant.MENU_HOME).counter = mHomeCounter;
		notifyDataSetChanged();
	}
